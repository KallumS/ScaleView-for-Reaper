 ...
 *
 *                 Alt is ScaleView with a different way of naming the chord
 *                 you are holding. Rather than matching the notes against a
 *                 table of shapes, it reads the chord: it takes the third,
 *                 the fifth and the seventh as the quality, and describes
 *                 whatever is left over as sixths, ninths, elevenths and
 *                 thirteenths. A voicing nobody thought to tabulate still
...
local EXT_LEGACY   = {
  ...
  "kallums_ScaleViewPro",
  "kallums_ScaleViewEnharmonic",
}
  ...
  if seventh ~= "none" and seventh ~= "bb7" then
    ...
    if sixth then
      ...
      if naturals[9] and (third == "maj" or third == "min") then
        naturals[9], name = nil, (third == "min" and "min6/9" or "6/9")
        cost = cost + COST_ADD
      elseif third == "maj" or third == "none" then name = name .. "6"
      elseif third == "min" then name = "min6"
